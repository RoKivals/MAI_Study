...
void build_space() {
	trigs[0] = {{-5, -5, 0}, {5, -5, 0}, {-5, 5, 0}, {0, 0, 255, 255}};
	trigs[1] = {{5, 5, 0}, {5, -5, 0}, {-5, 5, 0}, {0, 0, 255, 255}};
	trigs[2] = {{-2,-2, 4}, {2, -2, 4}, {0, 2, 4}, {128, 0, 128, 255}};
	trigs[3] = {{-2, -2, 4}, {2, -2, 4}, {0, 0, 7}, {255, 0, 0, 255}};
	trigs[4] = {{-2,-2, 4}, {0, 0, 7}, {0, 2, 4}, {255, 255, 0, 255}};
	trigs[5] = {{0, 0, 7}, {2, -2, 4}, {0, 2, 4}, {0, 255, 0, 255}};
/*	int i;
	for(i = 0; i < 6; i++) {
		print(trigs[i].a);
		print(trigs[i].b);
