...
## Указания
Работа выполняется в группах 5-7 человек. При написании отчёта необходимо чётко указать, кем была выполнена та или иная часть работы, поскольку возможно индивидуальное выставление оценки.
